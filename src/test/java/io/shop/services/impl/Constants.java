...
public class Constants {
    ...
    public static final Ad AD_1 =  new Ad (ID1, TITLE_1, DESCRIPTION_1, PRICE_1, USER_1);
    public static final Ad AD_2 =  new Ad (ID2, TITLE_2, DESCRIPTION_2, PRICE_2, USER_2);
